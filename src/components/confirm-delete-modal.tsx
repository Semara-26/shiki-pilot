      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white dark:bg-[#0a0a0a] border-2 border-ink dark:border-white/10 shadow-neo dark:shadow-xl dark:shadow-black/50 max-w-md w-full p-6 rounded-lg"
