      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="flex h-[500px] w-full max-w-5xl flex-col overflow-hidden rounded-md border border-ink/20 dark:border-white/10 bg-white shadow-xl shadow-black/50 dark:bg-[#0a0a0a]"
